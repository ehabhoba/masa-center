      ...
      >
        ...
        <div className="text-center">
          ...
          <div className="mt-6 text-center border-t border-gray-700 pt-4">
              <p className="text-gray-500 text-sm">أو يمكنك الاتصال مباشرة على:</p>
              <div className="flex flex-col sm:flex-row justify-center sm:space-x-6 rtl:sm:space-x-reverse mt-2" dir="ltr">
                  <a href="tel:01034403327" className="text-gray-300 hover:text-amber-400 text-lg transition-colors py-1">010-3440-3327</a>
                  <a href="tel:01034403328" className="text-gray-300 hover:text-amber-400 text-lg transition-colors py-1">010-3440-3328</a>
              </div>
          </div>
        </div>
      </div>
