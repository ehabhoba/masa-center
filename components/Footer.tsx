      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="border-t border-gray-700 pt-6 mt-6">
          <p className="text-sm">&copy; {new Date().getFullYear()} مركز ماسة. جميع الحقوق محفوظة.</p>
           <button onClick={onPrivacyPolicyClick} className="text-sm text-gray-500 hover:text-amber-400 transition-colors mt-2 focus:outline-none focus:ring-2 focus:ring-amber-500 rounded">
            سياسة الخصوصية
          </button>
        </div>
      </div>
