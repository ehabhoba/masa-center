  ...
  return (
    <footer className="bg-black text-gray-400 py-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-4">
          <p className="mb-2">للحجز والاستفسار:</p>
          <div className="flex flex-col sm:flex-row justify-center items-center sm:space-x-6 rtl:sm:space-x-reverse text-lg" dir="ltr">
            <a href="tel:01050006013" className="hover:text-amber-400 transition-colors block my-1 sm:my-0">010-5000-6013</a>
            <a href="tel:01034403327" className="hover:text-amber-400 transition-colors block my-1 sm:my-0">010-3440-3327</a>
            <a href="tel:01034403328" className="hover:text-amber-400 transition-colors block my-1 sm:my-0">010-3440-3328</a>
          </div>
        </div>
